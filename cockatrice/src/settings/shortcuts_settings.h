...
private:
    ...
    const QHash<QString, ShortcutKey> defaultShortCuts = {
        ...
        {"TabDeckEditor/aRemoveCard", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Delete Card"),
                                                  parseSequenceString(""),
                                                  ShortcutGroup::Deck_Editor)},
        {"TabDeckEditor/aUndo", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Undo"),
                                            parseSequenceString("Ctrl+Z"),
                                            ShortcutGroup::Deck_Editor)},
        {"TabDeckEditor/aRedo", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Redo"),
